...
$config['img_logo']    = '<img src="'.$this->domain.'/public/images/logo.png" height="30px" style="padding-left:15px;">';
...
$config['img_loading2']= '<img src="'.$this->domain.'/public/images/loading_small.gif" style="display:none;" id="loading" />';
