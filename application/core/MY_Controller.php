...
class APP_Controller extends CI_Controller{
	...
	function __construct() {
		...
		************************************************/ 
		$this->load
			 ->model(array(
				...
				'contestant_model','voucher_model'
			));
		...
		************************************************/
		...
		$this->template->set_metadata('meta_keywords', $this->config->item('meta_keywords')); 
		$this->template->set_metadata('meta_description', $this->config->item('meta_description'));  
	}
