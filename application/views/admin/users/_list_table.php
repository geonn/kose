	...
	<tbody>
		<tr> 
			...
			<th style="width: 100px;"><a href="javascript:void(0)" onclick="sorting('roles','<?= $new_sort ?>');">Roles <span id="roles_sortimg"></span></a></th>
	...
	<?php endforeach; ?>		
		...
		<?php 	}else{ ?>
			<tr><td colspan="6" ><div align='center'>No result found</div><td></tr>
		<?php  } ?>		
	</tbody>	
</table>	
