...
<html>
	<head>
		...
		<title>Event Campaign CMS| <?= $this->config->item('project_name') ?></title>
	...
	<body>
		...
		<div id="header" class="gradient">
            ...
            <a style="border:none;" class='logoutbutton' href="javascript:void(0);" onclick="confirmLogout();">Logout</a>
						<a href="<?= $this->config->item('admin_url') ?>/users/edit/<?= $this->user->get_memberid() ?>"><?= $this->authenticate->admin_username(); ?></a>
